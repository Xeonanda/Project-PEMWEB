        ...
        <div class="card-body">
            <form action="{{ route('tenants.update', $tenant->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="latitude_tenant" class="form-control" value="{{ $tenant->latitude_tenant}}" step="0.000001" required>
                </div>
                <div class="form-group">
                    <label for="longitude_tenant">Longitude Tenant</label>
                    <input type="number" name="longitude_tenant" class="form-control" value="{{ $tenant->longitude_tenant}}" step="0.000001" required>
                </div>
                <div class="form-group">
