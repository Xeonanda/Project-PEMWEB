                    ...
                    <div class="p-6">
                        ...
                        <form action="/login" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" id="email" name="email" placeholder="name@example.com" autofocus
                                    class="w-full px-4 py-2 border rounded-lg text-gray-900" required>
                                @error('email')
                            ...
                            <button type="submit" class="w-full bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-lg">Login</button>
                        </form>
                    </div>
